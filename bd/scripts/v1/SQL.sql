...
/* Created on:     16/09/2018 13:49:56                          */
/*==============================================================*/
...
create table VENTAS (
   ID                   SERIAL               not null,
   CAT_CLIENTE_ID       INT4                 null,
   CAT_PROVEEDOR_ID     INT4                 null,
   ESTADO               BOOL                 not null,
   FECHA                DATE                 not null,
...
alter table COMPRAS
   add constraint FK_COMPRAS_CAT_PERSO_CAT_PERS foreign key (CAT_PERSONA_ID)
...
alter table VENTAS
   add constraint FK_VENTAS_CAT_PERSO_CAT_CLIENTE foreign key (CAT_CLIENTE_ID)
      references CAT_PERSONAS (ID)
      on delete restrict on update restrict;

alter table VENTAS
   add constraint FK_VENTAS_CAT_PERSO_CAT_PROVE foreign key (CAT_PROVEEDOR_ID)
      references CAT_PERSONAS (ID)
      on delete restrict on update restrict;
